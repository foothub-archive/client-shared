...
export const _TOKEN_G = '_TOKEN_G'
export const _IS_LOADING_G = 'IS_LOADING_G'
...
export const TOKEN_G = `${namespace}/${_TOKEN_G}`
export const IS_LOADING_G = `${namespace}/${_IS_LOADING_G}`
export const TOKEN_M = `${namespace}/${_TOKEN_M}`
